type ClassesProps = { className: string };

const FavouriteIcon = (props: ClassesProps) => {
  ...
  return (
    ...
    >
      <g filter="url(#filter0_b_13182_78)">
        <ellipse
          cx="15"
          cy="15.1842"
          rx="15"
      ...
      <defs>
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_13182_78"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_backgroundBlur_13182_78"
            result="shape"
          />
        </filter>
      </defs>
